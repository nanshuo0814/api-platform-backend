...
public class InterfaceInfoController {
     ...
     */
    @PostMapping("/add")
    public ApiResponse<Long> addInterfaceInfo(@RequestBody InterfaceInfoAddRequest interfaceInfoAddRequest, HttpServletRequest request) {
        ...
        return ApiResult.success(newInterfaceInfoId);
    }
     ...
     */
    @PostMapping("/delete")
    public ApiResponse<Boolean> deleteInterfaceInfo(@RequestBody IdRequest idRequest, HttpServletRequest request) {
     ...
     */
    @PostMapping("/update")
    public ApiResponse<Boolean> updateInterfaceInfo(@RequestBody InterfaceInfoUpdateRequest interfaceInfoUpdateRequest,
     ...
     * @return {@code ApiResponse<InterfaceInfo>}
     */
    @GetMapping("/get")
    @Check(checkParam = true)
    public ApiResponse<InterfaceInfo> getInterfaceInfoById(IdRequest idRequest) {
        long id = idRequest.getId();
        if (id <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        InterfaceInfo interfaceInfo = interfaceInfoService.getById(id);
        return ApiResult.success(interfaceInfo);
    }
    ...
    @GetMapping("/list")
    public ApiResponse<List<InterfaceInfo>> listInterfaceInfo(InterfaceInfoQueryRequest interfaceInfoQueryRequest) {
        ...
        return ApiResult.success(interfaceInfoList);
    }
    ...
    public ApiResponse<Page<InterfaceInfo>> listInterfaceInfoByPage(InterfaceInfoQueryRequest interfaceInfoQueryRequest, HttpServletRequest request) {
        if (interfaceInfoQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        InterfaceInfo interfaceInfoQuery = new InterfaceInfo();
        ...
        return ApiResult.success(interfaceInfoPage);
    }
